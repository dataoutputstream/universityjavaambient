package poo.valutatoreespressionistack;
...
public class ValutaEspressioneStack extends Precedenza{
	...
	int valutaEspressione(StringTokenizer st){
		...
		}//quando non ha più token, viene provato un ciclo for per 
		//operare tutti gli operatori fin quando l'operatore precedente non ha maggior
		//priorità di quello successivo.
		...
		//se ancora lo stack operatori non è vuoto appendo i caratteri ricostruendo la stringa e 
				//rifaccio calcolare ricorsivamente il contenuto restante
		if(operatori.size()!=0){
...
public static boolean benformata(String espressione) {
	String operando="\\d+";
	String operatore="[\\+\\-\\*/%\\^]";
	//FIX HEREEEEEEEEEEEEEEEEEEEEEEEEEE
	String paperta="[\\(]*?";
	/////////////////////////////////////
	String pchiusa="[\\)]?";
...
//metodo statico di utilità.
	...
	public static void main(String... args){
		...
		for(;;){
			...
			ValutaEspressioneStack ve=new ValutaEspressioneStack();
