...
public class AlberoBinarioDiRicerca2<T extends Comparable<? super T>> extends CollezioneOrdinataAstratta<T> {
	...
	public boolean equals(Object o) {
		...
		return equals(this.radice, ((AlberoBinarioDiRicerca2)o).radice);
	} // equals
	...
	private void frontiera(List<T> l, Albero<T> radice2) {
		if(radice2.figlioSinistro==null && radice2.figlioDestro==null) {
			l.add(radice2.info);
		}else {
			if(radice2.figlioSinistro!=null)frontiera(l,radice2.figlioSinistro);
			if(radice2.figlioDestro!=null)frontiera(l,radice2.figlioDestro);
		}
	...
	public static void main(String[]args) {
		AlberoBinarioDiRicerca2<Integer> abr = new AlberoBinarioDiRicerca2<Integer>();
